...
export default defineAuthedHandler(
  async (req, res, ctx) => {
    ...
    if (req.method === 'PATCH') {
      ...
      if (body.urgencyScore !== undefined) updates.urgencyScore = body.urgencyScore
      ...
      await triggerToTenant(tenantId, 'conversation:updated', updated as unknown as Record<string, unknown>)
