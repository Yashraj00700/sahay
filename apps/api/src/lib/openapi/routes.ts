...
registerRoute({
  ...
  description:
    "Returns 200 if the function process is running. No dependencies checked.",
  tags: ["system"],
  responses: {
    200: {
...
registerRoute({
  ...
  description:
    "Probes Postgres, Redis, and the Anthropic API. 503 if any probe fails.",
  tags: ["system"],
  responses: {
    200: {
...
registerRoute({
  ...
  description:
    "Returns access + refresh tokens and the agent/tenant principal.",
  tags: ["auth"],
  request: {
    body: z
      .object({
      ...
      schema: z
        .object({
          ...
          expiresIn: z
            .number()
            .int()
            .openapi({ description: "Access token TTL in seconds." }),
          agent: AuthAgent,
          tenant: AuthTenant,
        })
...
registerRoute({
  ...
  description:
    "Marks the agent offline. Tokens remain valid until expiry; client should drop them.",
  tags: ["auth"],
  security: BEARER,
  responses: {
    200: {
...
registerRoute({
  ...
  responses: {
    200: {
      ...
      schema: z
        .object({ agent: AuthAgent, tenant: AuthTenant })
        .openapi("MeResponse"),
    },
    401: commonErrors[401],
  },
...
registerRoute({
  ...
  description:
    "Tenant-scoped, paginated list with optional status/channel/assignee filters.",
  tags: ["conversations"],
  security: BEARER,
  request: {
    query: z
      .object({
        ...
        sortBy: z
          .enum(["createdAt", "updatedAt", "urgencyScore"])
          .default("updatedAt"),
...
registerRoute({
  ...
  responses: {
    200: {
      description: "Updated conversation row.",
...
registerRoute({
  ...
  description:
    "Returns messages newest-first internally then reversed; use `nextCursor` (an ISO timestamp) for older pages.",
  tags: ["conversations"],
  security: BEARER,
  request: {
    params: ConversationIdParam,
...
registerRoute({
  ...
  description:
    "Sets status=resolved, resolvedAt=now, and computes resolutionTimeSeconds.",
  tags: ["conversations"],
  security: BEARER,
  request: { params: ConversationIdParam },
  responses: {
...
registerRoute({
  ...
  description:
    "Currently returns `{ suggestion: null }`. Will produce a Claude-generated draft reply for the active conversation.",
  tags: ["ai"],
  security: BEARER,
  responses: {
    200: {
...
registerRoute({
  ...
  description:
    "Currently returns an empty list. Will support full-text search and tag filters.",
  tags: ["kb"],
  security: BEARER,
  responses: {
    200: {
...
registerRoute({
  ...
  description:
    "Skeleton response — will return CSAT, AHT, AI deflection, channel breakdown.",
  tags: ["analytics"],
  security: BEARER,
  responses: {
    200: {
...
registerRoute({
  ...
  description:
    "Returns the per-tenant configuration for WhatsApp / Instagram / webchat / email channels.",
  tags: ["settings"],
  security: BEARER,
  responses: {
    200: {
...
registerRoute({
  ...
  responses: {
    200: {
      description: "Event accepted (or unknown topic, intentionally ignored).",
    },
    400: {
      description: "Bad/missing topic header or invalid JSON.",
      schema: ErrorResponse,
    },
    401: {
      description: "Bad/missing HMAC, missing shop, or unknown tenant.",
      schema: ErrorResponse,
    },
    429: {
      description: "Rate limited; Shopify will retry.",
      schema: ErrorResponse,
    },
    500: {
      description: "Body read or enqueue failed; Shopify will retry.",
      schema: ErrorResponse,
    },
  },
});
