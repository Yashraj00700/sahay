...
export function escalationAlertTemplate(args: EscalationAlertArgs): RenderedEmail {
...
export function onboardingWelcomeTemplate(args: OnboardingWelcomeArgs): RenderedEmail {
