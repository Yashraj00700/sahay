...
const COLUMNS: ReadonlyArray<ColumnDef> = [
  ...
  {
    key: "conversationsHandled",
    label: "Handled",
    align: "right",
    numeric: true,
  },
  {
    key: "conversationsResolved",
    label: "Resolved",
    align: "right",
    numeric: true,
  },
  {
    key: "avgResponseTimeSec",
    label: "Avg 1st Resp",
    align: "right",
    numeric: true,
  },
  {
    key: "avgResolutionTimeSec",
    ...
    return (
      <div className="bg-surface border border-border rounded-xl p-8 text-center">
        ...
        <p className="text-xs text-text-secondary mt-1">
          Once your team handles conversations in this date range, their metrics
          will appear here.
        </p>
      </div>
    );
