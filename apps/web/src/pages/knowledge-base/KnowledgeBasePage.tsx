...
const MOCK_ARTICLES: KBArticle[] = [
  {
    id: "1",
    title: "Rose Hip Face Oil — Ingredients & Usage",
  ...
  {
    id: "4",
    title: "Vitamin C Brightening Serum — Skincare Routine",
  ...
  {
    id: "6",
    title: "COD to Prepaid Conversion FAQ",
  ...
  {
    id: "7",
    title: "Scalp & Hair Oil — Usage Guide",
  ...
  },
  {
    ...
    content:
      "Bakuchiol: Plant-based retinol alternative. Suitable for sensitive skin...",
    sourceType: "brand",
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((f) => ({
                    ...f,
                    sourceType: e.target.value as KBArticle["sourceType"],
                  }))
                }
  ...
  return (
    <div className="h-full flex flex-col bg-background">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-text-secondary mt-0.5">
              {articles.length} articles · {totalChunks} chunks ·{" "}
              {totalHits.toLocaleString()} total retrievals
            </p>
          </div>
      ...
      <div className="flex-shrink-0 border-t border-border px-6 py-2.5 flex items-center gap-6 text-xs text-text-secondary bg-surface">
        <span>
          {filtered.length} of {articles.length} articles shown
        </span>
        <span>·</span>
