...
const BUBBLES = [
  ...
  {
    text: "My face oil delivered in 1 day! 🌸",
    lang: "en",
    delay: 0.4,
    x: "55%",
    y: "15%",
  ...
  {
    text: "Vitamin C serum suits dry skin?",
    lang: "en",
    delay: 1.6,
    x: "5%",
    y: "76%",
...
function AnimatedStat({
  ...
  return (
    ...
    >
      <div className="text-3xl font-black text-white tracking-tight mb-0.5">
        {value}
      </div>
    ...
    >
      ...
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden flex-col">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, #0a0718 0%, #0d0b1a 40%, #110828 100%)",
          }}
        />
        ...
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            ...
            style={{
              ...
              left: "-80px",
              background:
                "radial-gradient(circle, #6B4EFF40 0%, transparent 70%)",
              filter: "blur(40px)",
            }}
          />
          <motion.div
          ...
          <motion.div
            ...
            style={{
              ...
              left: "30%",
              background:
                "radial-gradient(circle, #8669FF25 0%, transparent 70%)",
              filter: "blur(30px)",
            }}
          />
        </div>
        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          >
            ...
            <h1
              className="text-5xl font-black text-white leading-[1.05] tracking-tight mb-6"
            ...
            <p className="text-white/50 text-base leading-relaxed max-w-xs">
              Resolve 70% of queries across WhatsApp, Instagram & web — in
              Hindi, Hinglish, English. Automatically.
            </p>
          </motion.div>
            ...
            <div className="flex -space-x-1.5">
              {["RAS", "MNS", "FRG"].map((brand, i) => (
                <div
                  ...
                  style={{
                    background: ["#6B4EFF", "#F59E0B", "#10B981"][i],
                    zIndex: 3 - i,
                  }}
                >
                  {brand[0]}
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label
                ...
                style={{
                  color:
                    focused === "email" ? "#8669FF" : "rgba(255,255,255,0.45)",
                }}
              >
                Email address
              </label>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link
                  ...
                  onMouseEnter={(e) =>
                    ((e.target as HTMLElement).style.color = "#8669FF")
                  }
                  onMouseLeave={(e) =>
          ...
          >
            ...
            <a
              ...
              onMouseLeave={(e) =>
                ((e.target as HTMLElement).style.color = "rgba(107,78,255,0.7)")
              }
            >
              Book a demo →
            </a>
