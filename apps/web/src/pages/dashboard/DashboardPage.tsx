...
function truncate(t: string, l = 52) {
...
function Badge({ channel }: { channel: Channel }) {
  ...
  return (
    <span
      className={`text-[10px] font-medium px-1.5 py-0.5 rounded-full ${c.cls}`}
    >
      {c.label}
    </span>
  );
...
function Delta({ d }: { d: number | null }) {
  ...
  return (
    <span
      className={`text-xs font-medium flex items-center gap-0.5 ${d > 0 ? "text-emerald-600" : "text-red-500"}`}
    >
...
function MetricCard({
  ...
  return (
    ...
    >
      ...
      {extra && (
        <p className="text-[10px] text-text-muted leading-relaxed">{extra}</p>
      )}
    </motion.div>
  );
}
  ...
  return (
    <div className="bg-white border border-border rounded-xl shadow-card px-3 py-2 text-sm">
      ...
      <p className="font-semibold text-text-primary">
        {fmt(payload[0].value)} conversations
      </p>
    </div>
  );
}
...
const FEED = [
  {
    msg: "✦ AI resolved order query for Anjali M. in 23s",
    ch: "WhatsApp",
    ago: "2 min ago",
  },
  {
    msg: "✦ AI suggested COD→Prepaid conversion for order #8821",
    ch: "WhatsApp",
    ago: "5 min ago",
  },
  {
    msg: "✦ AI escalated Priya S. to human (frustration detected)",
    ch: "Instagram",
    ago: "8 min ago",
  },
  {
    msg: "✦ AI sent proactive shipping update to 47 customers",
    ch: "WhatsApp",
    ago: "12 min ago",
  },
  {
    msg: "✦ AI resolved return request for Deepika N. (instant refund link)",
    ch: "Webchat",
    ago: "15 min ago",
  },
  {
    msg: "✦ AI converted Meera J. from COD to prepaid — ₹2,499 secured",
    ch: "WhatsApp",
    ago: "19 min ago",
  },
  {
    msg: "✦ AI answered ingredient query for Kavya S. — 3 products recommended",
    ch: "Instagram",
    ago: "24 min ago",
  },
  {
    msg: "✦ AI flagged damaged order #4567 as urgent — human loop triggered",
    ch: "WhatsApp",
    ago: "31 min ago",
  },
];
...
const LIVE = [
  ...
  {
    msg: "AI resolved query for Aditya Kumar (Confidence: 94%)",
    ago: "2m ago",
  },
...
const PENDING = [
  {
    type: "Escalated conversation",
    desc: "Priya Sharma — frustrated about delayed order",
  },
  {
    type: "Escalated conversation",
    desc: "Rahul Mehta — wrong product received",
  },
  {
    type: "Escalated conversation",
    desc: "Anjali Kapoor — refund not credited",
  },
  { type: "CSAT survey to review", desc: "2 negative ratings submitted today" },
  {
    type: "Knowledge base gap",
    desc: '"How to track international orders?" — asked 8× today, unanswered',
  },
];
...
export function DashboardPage() {
  ...
  const { data: analytics, isLoading: aLoading } = useQuery<AnalyticsOverview>({
    ...
    queryFn: () =>
      apiRequest<AnalyticsOverview>("GET", "/analytics/overview", undefined, {
        period: "7d",
      }),
    staleTime: 2 * 60 * 1000,
    retry: 1,
  ...
  const { data: convsRes, isLoading: cLoading } =
    useQuery<ConversationsResponse>({
      queryKey: ["conversations", "recent"],
      queryFn: () =>
        apiRequest<ConversationsResponse>("GET", "/conversations", undefined, {
          limit: 6,
        }),
      staleTime: 60 * 1000,
      retry: 1,
      ...
      <div className="max-w-[1400px] mx-auto px-4 py-6 lg:px-6">
        ...
        >
          ...
          <p className="text-sm text-white">
            Sahay saved <span className="font-bold">4.2 hours</span> of agent
            time today —
            <span className="text-white/80 ml-1">
              103 conversations resolved by AI without human touch.
            </span>
          </p>
        </motion.div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="p-5">
                ...
                <p className="text-3xl font-bold text-emerald-600 mb-0.5">
                  ₹2,84,500
                </p>
                ...
                <p className="text-xs text-text-muted mb-4">
                  ₹1,24,500 in support costs + ₹1,60,000 in failed delivery
                  prevention
                </p>
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div
                      key={i}
                      className="bg-background rounded-xl p-2.5 text-center"
                    >
              ...
              <Card className="p-5">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={i}
                      className={`rounded-xl p-3 ${i === 0 ? "bg-violet-50" : "bg-gray-50"}`}
                    >
                  ...
                  <div className="flex gap-2 pt-1">
                    <span className="bg-violet-100 text-violet-700 text-[10px] font-semibold px-2 py-0.5 rounded-full">
                      10× cheaper
                    </span>
                ...
                {[
                  {
                    name: "WhatsApp",
                    status: "Connected",
                    detail: "1,247 msgs today · Response time 1.1s",
                    dot: "bg-emerald-400",
                  },
                  {
                    name: "Instagram",
                    status: "Connected",
                    detail: "312 msgs today · Response time 2.3s",
                    dot: "bg-emerald-400",
                  },
                  {
                    name: "Shopify",
                    status: "Synced 2m ago",
                    detail: "85 products · 2,847 customers",
                    dot: "bg-emerald-400",
                  },
                ].map((ch, i) => (
                  <div key={i} className="bg-background rounded-xl p-3.5">
                    <div className="flex items-center gap-2 mb-1.5">
                      <span
                        className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${ch.dot}`}
                      />
                ...
                {aLoading ? (
                  ...
                  <>
                    <MetricCard
                      ...
                      value={fmt(analytics.totalConversations)}
                    ...
                    <MetricCard
                      ...
                      value={fmtPct(analytics.aiResolutionRate)}
                    ...
                    <MetricCard
                      ...
                      value={fmtSecs(analytics.avgFirstResponseSeconds)}
                      delta={null}
                    ...
                    <MetricCard
                      label="CSAT Score"
                      value={
                        analytics.avgCsat !== null
                          ? `${analytics.avgCsat.toFixed(1)}`
                          : "—"
                      }
                    ...
                    <MetricCard
                      ...
                      value="₹1.24L"
                      delta={18.5}
                      icon={<IndianRupee size={14} className="text-pink-600" />}
                      iconBg="bg-pink-100"
                    ...
                    {[
                      {
                        ...
                        msg: "Thank you! Lekin ek aur cheez — face oil mein koi fragr…",
                        ago: "3m ago",
                      },
                      {
                        name: "Kavya Singh",
                        ch: "whatsapp" as Channel,
                        msg: "Haan Kavya ji! COD bilkul available hai...",
                        ago: "5m ago",
                      },
                      {
                        name: "Riya Patel",
                        ch: "instagram" as Channel,
                        msg: "That sounds amazing! What's the price?",
                        ago: "8m ago",
                      },
                      {
                        name: "Meera Joshi",
                        ch: "instagram" as Channel,
                        msg: "This is the 2nd time this has happened. Very disappoint…",
                        ago: "10m ago",
                      },
                      {
                        name: "Pooja Mehta",
                        ch: "whatsapp" as Channel,
                        msg: "Full refund of ₹2,499 has been initiated.",
                        ago: "13m ago",
                      },
                      {
                        name: "Deepika Nair",
                        ch: "whatsapp" as Channel,
                        msg: "Thanks! Got the tracking link 🙏",
                        ago: "4h ago",
                      },
                    ].map((c, i) => (
                      <li
                        key={i}
                        className="flex items-start gap-3 px-4 py-3 hover:bg-violet-50/40 cursor-pointer transition-colors"
                      >
                    ...
                    {convs.slice(0, 6).map((c) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[11px] text-text-muted line-clamp-1">
                            {truncate(c.lastMessage?.content ?? "", 52) || (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card
                className="p-5"
                aria-label="Revenue and conversion insights"
              >
                ...
                {[
                  ...
                  <div
                    key={i}
                    className="flex justify-between text-xs py-1 border-b border-border last:border-none"
                  >
              ...
              <Card className="p-5">
                ...
                <p className="text-[10px] text-text-muted mt-2">
                  Based on this month · 342 ratings
                </p>
              </Card>
              ...
              <Card className="p-5">
                  ...
                  {[
                    ...
                    <div key={i} className="flex-1">
                      <div
                        ...
                        style={{ width: `${b.pct}%`, minWidth: "24px" }}
                      >
                        <div
                          className={`h-full rounded-full ${b.color} w-full`}
                        />
                      </div>
                ...
                <p className="text-xs text-text-muted">
                  Savings: ₹42,000 in failed delivery costs avoided
                </p>
                <p className="text-[10px] text-text-muted mt-1">
                  converted this month · 89 orders
                </p>
              </Card>
            </div>
            ...
            <Card aria-label="Revenue impact">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 divide-x divide-border">
                {[
                  {
                    label: "Revenue Saved from RTO Prevention",
                    value: "₹1,84,500",
                    delta: "+23%",
                    note: "Return-to-origin orders blocked by AI proactive follow-up",
                  },
                  {
                    label: "COD Conversion Revenue",
                    value: "₹48,500",
                    delta: "+34%",
                    note: "34% COD→Prepaid conversion rate — 89 orders this month",
                  },
                  {
                    label: "AI Support Cost Savings",
                    value: "₹1,12,000",
                    delta: "+18%",
                    note: "vs ₹3,50,000 for 3 human agents at equivalent volume",
                  },
                ].map((r, i) => (
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="mt-2">
                  ...
                  <div className="flex gap-0.5 items-end h-8">
                    {[4, 6, 5, 7, 4, 8, 6, 5, 7, 9, 6, 7, 5, 8, 7].map(
                      (v, i) => (
                        <div
                          key={i}
                  ...
                  <li key={i} className="px-4 py-3">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button className="text-[10px] font-medium text-violet-600 hover:text-violet-700 bg-violet-50 hover:bg-violet-100 px-2 py-1 rounded-lg transition-colors flex-shrink-0">
                        {p.type.includes("Knowledge")
                          ? "Add Answer"
                          : p.type.includes("CSAT")
                            ? "Review"
                            : "Respond"}
                      </button>
                    </div>
