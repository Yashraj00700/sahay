...
export const orders = pgTable(
  ...
  (table) => ({
    tenantOrderIdx: uniqueIndex("idx_orders_tenant_shopify_order").on(
      table.tenantId,
      table.shopifyOrderId,
    ),
    tenantCustomerIdx: index("idx_orders_tenant_customer").on(
      table.tenantId,
      table.customerId,
    ),
    tenantCreatedIdx: index("idx_orders_tenant_created").on(
      table.tenantId,
      table.createdAt,
    ),
  }),
