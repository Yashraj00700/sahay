...
export const customers = pgTable(
  ...
  (table) => ({
    tenantPhoneIdx: uniqueIndex("idx_customers_tenant_phone").on(
      table.tenantId,
      table.phone,
    ),
    tenantShopifyIdx: uniqueIndex("idx_customers_tenant_shopify").on(
      table.tenantId,
      table.shopifyCustomerId,
    ),
    tenantWaIdx: uniqueIndex("idx_customers_tenant_wa").on(
      table.tenantId,
      table.whatsappId,
    ),
    tenantIgIdx: uniqueIndex("idx_customers_tenant_ig").on(
      table.tenantId,
      table.instagramId,
    ),
