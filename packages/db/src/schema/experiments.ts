...
export const experiments = pgTable(
  ...
  (table) => ({
    ...
    tenantKeyIdx: index("idx_experiments_tenant_key").on(
      table.tenantId,
      table.key,
      table.isActive,
    ),
...
export const experimentAssignments = pgTable(
  ...
  (table) => ({
    ...
    experimentIdx: index("idx_exp_assignment_experiment").on(
      table.experimentId,
      table.variant,
    ),
    tenantIdx: index("idx_exp_assignment_tenant").on(
      table.tenantId,
      table.experimentId,
    ),
  }),
...
export const experimentOutcomes = pgTable(
  ...
  (table) => ({
    assignmentIdx: index("idx_exp_outcome_assignment").on(
      table.assignmentId,
      table.metric,
    ),
    metricIdx: index("idx_exp_outcome_metric").on(
      table.metric,
      table.recordedAt,
    ),
  }),
