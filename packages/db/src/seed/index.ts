...
async function seed() {
  ...
  const [adminAgent, supportAgent] = await db
    .insert(agents)
    .values([
      {
        tenantId: tenant.id,
  ...
  await db.insert(messages).values([
    // Conv 1: Priya tracking her Kumkumadi Elixir order
    {
      ...
      contentType: "text",
      content:
        "Hii, mera order kab aayega? Order #RAS-2024-8847 — Kumkumadi Elixir",
    ...
    },
    {
      ...
      contentType: "text",
      content:
        "Hi Priya! 🙏 Maine aapka order check kiya — Order #RAS-2024-8847 (Kumkumadi Elixir Oil) aaj evening 6 PM tak deliver ho jaayega. \n\nTracking: BlueDart AWB 3421567890 → Currently in Delhi hub, out for delivery. Koi aur help chahiye? 😊",
      aiConfidence: "0.92",
    ...
    // Conv 2: Anita asking for product recommendation
    {
      ...
      contentType: "text",
      content:
        "Hi! I have oily skin with pigmentation issues. Which of your products would you recommend? Budget around ₹2000",
      channelStatus: "delivered",
